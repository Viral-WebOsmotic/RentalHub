        ...
        <div className="row" id="tabs">
            ...
            <ul>
              <li>
                <Link to="#tabs-1" onClick={() => handleTabClick("tabs-1")}>
                  ...
                  <small>Ritik Singh &nbsp;|&nbsp; 27.07.2020 10:10</small>
                </Link>
              </li>
              <li>
          ...
          <div className="col-md-8">
            <section className="tabs-content">
              ...
              >
                <img
                  src={require("../images/blog-image-1-940x460.jpg")}
                  alt="Random ALT"
                />
                <h4>
              ...
              >
                <img
                  src={require("../images/blog-image-2-940x460.jpg")}
                  alt="Random ALT"
                />
                <h4>
                  <Link to="blog-details.html">
              ...
              >
                <img
                  src={require("../images/blog-image-3-940x460.jpg")}
                  alt="Random ALT"
                />
                <h4>
                  <Link to="/">
